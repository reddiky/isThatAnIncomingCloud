...
app.use(
  '/weather',
  cors<cors.CorsRequest>({ origin: ['https://isthatanincoming.cloud', 'https://reddiky.github.io', 'https://reddiky.github.io/', 'https://reddiky.github.io/isThatAnIncomingCloud'] }),
  express.json(),
